...
// Addy Shopify Plug-in
function intAddyCompleteShopify() { new AddyComplete(document.getElementById("checkout_shipping_address_address1")).fields = { address1: document.getElementById("checkout_shipping_address_address1"), address2: document.getElementById("checkout_shipping_address_address2"), city: document.getElementById("checkout_shipping_address_city"), postcode: document.getElementById("checkout_shipping_address_zip"), region: document.getElementById("checkout_shipping_address_province") }; var e = document.createElement("link"); e.setAttribute("rel", "stylesheet"), e.setAttribute("type", "text/css"), e.setAttribute("href", "https://addycdn.azureedge.net/autocomplete/2.1.1/addycomplete.min.css"), document.getElementsByTagName("head")[0].appendChild(e) } intAddyCompleteShopify();